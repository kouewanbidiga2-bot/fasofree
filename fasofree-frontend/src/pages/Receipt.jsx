      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white border border-border-light p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-success rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#5C6B3C' }}>
          ...
          <div className="border-b border-border-light pb-6 mb-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-sm font-mono font-medium text-text-primary">{orderDetails.id}</span>
            </div>
            <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-4">
            <button
              onClick={handlePrint}
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border border-border-light text-text-secondary hover:border-accent-primary hover:text-accent-primary transition-colors"
