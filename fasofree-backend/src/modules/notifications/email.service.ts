    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #FAF6F1; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <a href="https://fasofree-admin.onrender.com" style="display: inline-block; background: #C1652E; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin-top: 10px;">Accéder au Dashboard</a>
        </div>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #FAF6F1; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="https://fasofree-admin.onrender.com" style="display: inline-block; background: #C1652E; color: white; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-weight: bold;">Accéder à mon tableau de bord</a>
          </div>
